...
def Define(app):
    ...
    router = Blueprint('tron', __name__, url_prefix='/tron')
        ...
        for player in games[people][game_no-1]["players"]:
            if not games[people][game_no-1]["players"][player]["dead"]:
                ...
                match games[people][game_no-1]["players"][player]["direction"]:
                    case "up":
                        games[people][game_no -
                                      1]["players"][player]["cord"][1] -= speed
                    case "down":
                        games[people][game_no -
                                      1]["players"][player]["cord"][1] += speed
                    case "left":
                        games[people][game_no -
                                      1]["players"][player]["cord"][0] -= speed
                    case "right":
                        games[people][game_no -
                                      1]["players"][player]["cord"][0] += speed
